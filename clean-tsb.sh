...
kubectl get mutatingwebhookconfigurations -o custom-columns=:metadata.name | xargs -I {} kubectl delete mutatingwebhookconfigurations {}  --timeout=10s --wait=false
...
kubectl get validatingwebhookconfigurations -o custom-columns=:metadata.name | xargs -I {} kubectl delete validatingwebhookconfigurations {} --timeout=10s --wait=false
